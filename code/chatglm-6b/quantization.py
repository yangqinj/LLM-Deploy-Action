...
try:
    ...
    # 用于权重量化和反量化的 CUDA kernels
    kernels = Kernel(
        bz2.decompress(base64.b64decode(quantization_code)),
        [
            "int4WeightCompression", # INT4量化
            "int4WeightExtractionFloat", # INT4反量化为FP32
            "int4WeightExtractionHalf", # INT4反量化为FP16
            "int8WeightExtractionFloat", # INT8反量化为FP32
            "int8WeightExtractionHalf", # INT8反量化为FP16
        ],
    )
